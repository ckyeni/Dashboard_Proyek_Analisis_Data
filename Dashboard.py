...
st.subheader("Total Penyewaan Sepeda Berdasarkan Bulan")
...
ax.set_title(f"Tren Total Penyewaan Sepeda per Bulan ({year_option})")
ax.legend()
ax.grid(False)
st.pyplot(fig)
...
st.subheader("Total Penyewaan Sepeda Berdasarkan Hari Kerja")
...
st.subheader("Perbandingan Total Penyewaan Sepeda Berdasarkan Weathersit")
